...
// Emetteur 433 MHz
const int pinEmetteur = 13;
const char codebouton[]="1100110011"; //  code à  envoyer
//const char codebouton[]="0000000000"; //  code à  envoyer
const int nbrepet=600; // nbre de répétition du code
...
void Emission(const char* code) 
{
  ...
  for(int j=0;j<nbrepet;j++) { // boucle pour nbrepet répétitions de l'émission
    for(int i=0;i<10;i++) { // boucle sur les 10 digits du code
      if(code[i]=='1') {
        // émission d'un "1"
