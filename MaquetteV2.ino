...
const char codeultrason[]="1000110110110001"; //  code à  envoyer
const char codefourche[]="1001100110011001"; //  code à  envoyer
...
{
  // code de 16 digits obligatoirement
  for(int j=0;j<nbrepet;j++) { // boucle pour nbrepet répétitions de l'émission
    for(int i=0;i<16;i++) { // boucle sur les 16 digits du code
      if(code[i]=='1') {
        // émission d'un "1"
